...
//LISTCOMMIT 
// commit add kelas page
//commit add nestedscroll 
//commit add feat tambah kelas 
//commit add build card 
//commit add nav/ animation 

//git switch feat/week-005-navigation and animation